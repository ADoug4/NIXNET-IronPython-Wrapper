...
try:
    ...
    # can_session.create_frame_output_session(CAN_write_port, CAN_database, CAN_cluster, CAN_frames)
    can_session.create_frame_input_session(CAN_read_port, CAN_database, CAN_cluster, CAN_frames)
